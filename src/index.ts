...
// Estudantes
const student1 = new GradeRecord(
    'Lourival',
    '20251148060028'
)
...
const student2 = new GradeRecord(
    'João', 
    '20251158060027'
)
...
const student3 = new GradeRecord(
    'Maria',
    '20251168060026'
)
...
const student4 = new GradeRecord(
    'José',
    '20251178060025'
)
...
const student5 = new GradeRecord(
    'André',
    '20251188060024'
)
...
// Diário
const histLogbook = new Logbook(
    Course.HIST,
    'prof. Jalmenio da Silva',
    Shift.AFTERNOON,
    Program.TSI,
    '0051'
)
